            ...
            <div className="mt-8 space-y-6 text-wild-forest">
              ...
              <div className="pt-4">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-wild-forest hover:bg-wild-sunset flex items-center justify-center text-white transition-all duration-300 shadow-sm" aria-label="Twitter">
